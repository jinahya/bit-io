...
public class ConsumerOutput extends AbstractByteOutput<Consumer<Byte>> {
    ...
    /**
     * {@inheritDoc} The {@code write(int)} method of {@code ConsumerOutput}
     * class invokes {@link Consumer#accept(java.lang.Object)} on
     * {@link #target} with the value casted to {@code byte}. Override this
     * method if {@link #target} is supposed to be lazily initialized and set.
     *
