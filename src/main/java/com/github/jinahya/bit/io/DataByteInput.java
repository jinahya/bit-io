...
public class DataByteInput extends AbstractByteInput<DataInput> {
    ...
    /**
     * {@inheritDoc} The {@code read()} method of {@code DataByteInput} class {@link DataInput#readUnsignedByte() reads
     * an unsigned byte} from the {@link #getSource() source} and returns the result.
     *
     * @return {@inheritDoc}
