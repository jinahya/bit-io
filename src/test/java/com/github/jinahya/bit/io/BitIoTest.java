...
class BitIoTest {
    ...
    private static Arguments array() {
        ...
        final BitOutput output = new DefaultBitOutput<ByteOutput>(target);
    ...
    private static Arguments buffer() {
        ...
        final BitOutput output = new DefaultBitOutput<ByteOutput>(delegate);
        final Supplier<BitInput> inputSupplier = () -> {
    ...
    private static Arguments data() {
        ...
        final BitOutput output = new DefaultBitOutput<ByteOutput>(new DataByteOutput<DataOutput>(target));
        final Supplier<BitInput> inputSupplier = () -> {
